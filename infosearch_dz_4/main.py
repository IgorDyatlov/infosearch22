...
from scores import comparing_scores
...
def main(file='data.jsonl', file_processed='all_texts.txt'):
    ...
    with open('scores.txt', 'w', encoding='utf-8') as file:
        file.write(comparing_scores(data_texts, data_names, texts_opened, stop_words, count_vectorizer, tfidf_vectorizer, model, tokenizer))
